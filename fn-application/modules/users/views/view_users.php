              ...
              <div class="row">
                <div class="col-md-4 d-flex my-auto">
                  <div class="user-avatar mb-auto pt-3">
                    <img src="<?php echo base_url(); ?>fn-uploads/profiles/avatar.jpg" data-src="<?php echo base_url() . '/fn-uploads/profiles/' . $row->user_photo ?>" class="lazy profile-img img-md rounded-circle">
