      ...
      <table class="table shadow-sm ctm-table bg-white data-table">
        <thead>
          <tr>
            ...
            <th><i class="mdi mdi-code-brackets icon-sm align-self-center text-primary mr-3"></i>Faculty Name</th>
            <th class="text-right">
              <a href="<?php echo base_url(); ?>advisers/add" class="btn btn-primary" style="text-transform: capitalize;"><i class="mdi mdi-plus"></i> New Faculty</a>
            </th>
          </tr>
        </thead>
        <tbody>
            ...
            <tr>
              ...
              <td>
                <div class="media">
                  ...
                  <div class="media-body my-auto">
                    <p class="mb-0">
                      <a href="<?php echo base_url(); ?>advisers/list/?id=<?php echo $row->adviser_id; ?>" style="text-decoration: none;">  
                        <?php echo ucwords( $row->adviser_name ); ?>
                      </a>
                    </p>
                  </div>
                </div>
